...
parser.add_argument('--model-path', default='model/model_cur.pth')
...
parser.add_argument('--acjd_weight',type=float,default=0.3)
parser.add_argument('--lambda_jump',type=float,default=0.1)
#parser.add_argument('--acjd_score_json',type=float,default='./utils/acjd_by_npy_frame_scores.json')
#parser.add_argument('--acjd_bin_json',type=float,default='./utils/acjd_by_npy_binary.json')